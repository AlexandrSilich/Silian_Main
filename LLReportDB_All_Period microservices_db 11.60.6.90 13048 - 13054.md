...
ℹ️ Запрос на 1-м месте по генерации WAL: 8746.72 MB (17.5%)
...
ℹ️ Запрос на 2-м месте по генерации WAL: 6500.83 MB (13.0%)
...
ℹ️ Запрос на 5-м месте по генерации WAL: 2948.03 MB (5.9%)
...
*Отчет сгенерирован автоматически 2026-01-23 02:24:46*
