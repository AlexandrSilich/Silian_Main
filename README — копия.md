...
- [Критерии анализа и пороговые значения](#критерии-анализа-и-пороговые-значения)
- [Приоритеты в отчете](#приоритеты-в-отчете)
- [Структура отчета (актуальная)](#структура-отчета-актуальная)
- [Структура выходного файла](#структура-выходного-файла)
- [Как это работает](#как-это-работает)
- [Пример вывода](#пример-вывода)
- [Технические детали](#технические-детали)
- [Возможные ошибки](#возможные-ошибки)
- [Требования к файлам](#требования-к-файлам)
- [Вклад в проект](#вклад-в-проект)
- [Лицензия](#лицензия)
- [Связанные проекты](#связанные-проекты)
- [Контакты](#контакты)
- [Описание столбцов в Excel файле](#описание-столбцов-в-excel-файле)
